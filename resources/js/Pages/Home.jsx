...
export default function Home({ popularMotors }) {
    ...
    return (
        <MainLayout title="Home">
            ...
            <section
                id="home"
                className="relative min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-white via-indigo-50 to-blue-50 overflow-hidden px-6 pt-20"
            >
                {/* Decorative Elements */}
