...
<section class="motors-preview" id="motors-preview">
    ...
    <p class="text-center mb-4" style="font-size: 1.5rem;">Temukan berbagai pilihan motor yang sesuai dengan kebutuhan Anda</p>
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card h-100 text-center">
                <div class="card-body d-flex flex-column justify-content-center">
                    <h5 class="card-title" style="font-size: 2rem;">Yamaha</h5>
                    <p class="card-text" style="font-size: 1.4rem;">Temukan berbagai pilihan motor Yamaha dengan kualitas terjamin.</p>
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100 text-center">
                <div class="card-body d-flex flex-column justify-content-center">
                    <h5 class="card-title" style="font-size: 2rem;">Honda</h5>
                    <p class="card-text" style="font-size: 1.4rem;">Berbagai pilihan motor Honda terbaru dengan teknologi canggih.</p>
